                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                ...
                                @endif
                                    <a href="{{route('ticket.close', $ticket_object->ticket)}}" class="btn btn-danger" style="height: 35px;">Click To Make Close</a>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel-body">
                                            <fieldset class="col-md-12">
                                                @if($data->type == 1)
                                                    <legend><span style="color: #0e76a8">{{Auth::guard('customer')->user()->full_name}}</span> , <small>{{ \Carbon\Carbon::parse($data->updated_at)->format('F dS, Y - h:i A') }}</small></legend>
                                                @else
                                                    <legend><span style="color: #0e76a8">{{$general->name}}</span> , <small>{{ \Carbon\Carbon::parse($data->updated_at)->format('F dS, Y - h:i A') }}</small></legend>
                                                @endif
