...
class TicketController extends Controller
{
    ...
    {
        $all_ticket =Ticket::where('customer_id', Auth::guard('customer')->user()->id)
           ->orderBy('id', 'desc')->paginate(15);
        return view('customer.support.support', compact('all_ticket'));
    }

    public function ticketCreate()
    {
        return view('customer.support.add_ticket');
    }
    ...
    {
        $ticket_object = Ticket::where('customer_id', Auth::guard('customer')->user()->id)
        ...
        if ($ticket_object  == '')
        {
            ...
            return view('customer.support.view_reply', compact('ticket_data', 'ticket_object'));
        }
    }
    ...
    public function indexSupport()
    {
        ...
        return view('backend.support.support', compact('all_ticket'));
    }
    ...
    public function adminSupport($ticket)
    {
        ...
        $ticket_data = TicketComment::where('ticket_id', $ticket)->get();
        return view('backend.support.view_reply', compact('ticket_object', 'ticket_data'));
    }
