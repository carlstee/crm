...
<div class="content" style="background-color: #0a6aa1">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form"  method="POST" action="{{ route('admin.login') }}">
        ...
        <div class="form-actions">
        <label class="control-label">
            <a style="color: white" href="{{route('password.reset')}}">Forget Password?</a></label>
        </div>
    </form>

</div>

<div class="copyright" style="color: darkred">2017 &copy; All Right Reserved</div>
