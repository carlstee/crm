                            ...
                            <div class="col-md-12">
                                <div class="form-body">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-md-9">
                                            <label class="radio-inline"><input id="due" type="radio" value="0" name="payment">Due</label>

                                            <input style="display: none" id="due_amount" placeholder="Due Amount" type="number"  name="due_amount">
